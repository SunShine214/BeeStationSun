...
/datum/supply_pack/materials/ionic_fuel_canister
	name = "Ionic Fuel Canister"
	desc = "Contains a canister of ionic fuel, used for orbital maneuvering thrusters."
	cost = 5000
	max_supply = 5
	contains = list(/obj/machinery/portable_atmospherics/canister/ionic_fuel)
	crate_name = "ionic fuel canister crate"
	crate_type = /obj/structure/closet/crate/large

/datum/supply_pack/materials/ionic_fuel_canister_double
	name = "Ionic Fuel Canister Double Pack"
	desc = "Contains two canisters of ionic fuel at a 10% discount!"
	cost = 9000
	max_supply = 3
	contains = list(
		/obj/machinery/portable_atmospherics/canister/ionic_fuel,
		/obj/machinery/portable_atmospherics/canister/ionic_fuel
	)
	crate_name = "ionic fuel double pack crate"
	crate_type = /obj/structure/closet/crate/large

/datum/supply_pack/materials/ionic_fuel_canister_triple
	name = "Ionic Fuel Canister Triple Pack"
	desc = "Contains three canisters of ionic fuel at a 20% discount!"
	cost = 12000
	max_supply = 2
	contains = list(
		/obj/machinery/portable_atmospherics/canister/ionic_fuel,
	...
	crate_name = "ionic fuel triple pack crate"
	crate_type = /obj/structure/closet/crate/large
